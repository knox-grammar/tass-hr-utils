/**
 * Encrypts the parameters for the employee-hr service
 */

import crypto from 'crypto'

/**
 * Encrypt the object of parameters
 * @param params - the parameters to encrypt
 * @param tokenKey - the token key from the config
 * @returns {string} - the encrypted parameters
 */
export const encryptParams = (params: object, tokenKey: string) => {
  ...
  return (
    cipher.update(JSON.stringify(params), 'utf8', 'base64') +
    cipher.final('base64')
  )
}
